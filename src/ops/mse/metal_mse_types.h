#ifndef GD_OP_MSE_METAL_TYPES_H
#define GD_OP_MSE_METAL_TYPES_H

#include "../../backends/metal/metal_abi.h"

#define GD_METAL_MSE_CHUNK_SIZE 4096U
#define GD_METAL_MSE_MAX_SIMDGROUPS 8U

typedef struct gd_metal_mse_args {
...
_Static_assert(sizeof(gd_metal_mse_args) == 80U,
               "gd_metal_mse_args ABI mismatch");
#endif

#endif /* GD_OP_MSE_METAL_TYPES_H */
