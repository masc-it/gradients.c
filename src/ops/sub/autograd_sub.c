...
static gd_status gd_sub_autograd_backward(gd_bwd_ctx *bwd,
                                          const gd_tape_node *node)
{
    ...
    GD_TRY(gd_sub_backward(bwd->ctx,
                           x,
                           y,
                           &grad_out,
                           need_x ? &dx : NULL,
...
const gd_autograd_rule gd_bwd_rule_sub = {
    .kind = GD_OP_SUB,
    .name = "sub",
    .backward = gd_sub_autograd_backward,
};
