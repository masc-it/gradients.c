...
/* Causal/no-bias forward split kernel: one threadgroup handles this many query
 * rows, with the same 8 channel lanes per row as the dK/dV split kernel. */
#define GD_METAL_SDPA_FWD_CAUSAL_QROWS 8
