...
GD_REF(gd_graph_add_input, gd_status, (gd_context *, gd_graph *, const char *, const gd_tensor_desc *, gd_tensor **, gd_graph_input **));
...
GD_REF(gd_graph_runner_create, gd_status, (gd_graph *, gd_graph_runner **));
GD_REF(gd_graph_runner_destroy, void, (gd_graph_runner *));
GD_REF(gd_graph_runner_bind, gd_status, (gd_graph_runner *, gd_graph_input *, gd_tensor *));
GD_REF(gd_graph_runner_run, gd_status, (gd_graph_runner *));
