...
static const gd_metal_pipeline_spec gd_metal_pipeline_specs[] = {
    ...
    GD_METAL_PIPELINE("gd_swiglu_forward_f16_kernel", swiglu_forward_f16_pso),
    GD_METAL_PIPELINE("gd_swiglu_backward_f16_kernel", swiglu_backward_f16_pso),
    GD_METAL_PIPELINE("gd_swiglu_split_forward_f16_kernel", swiglu_split_forward_f16_pso),
    GD_METAL_PIPELINE("gd_swiglu_split_backward_f16_kernel", swiglu_split_backward_f16_pso),
    ...
    GD_METAL_PIPELINE("gd_minimax_m3_index_topk_kernel", minimax_m3_index_topk_pso),
    GD_METAL_PIPELINE("gd_minimax_m3_sparse_attention_kernel", minimax_m3_sparse_attention_pso),
    GD_METAL_PIPELINE("gd_minimax_m3_sparse_attention_q4_kernel", minimax_m3_sparse_attention_q4_pso),
    ...
    GD_METAL_PIPELINE("gd_sdpa_varlen_bwd_saved_stats_dq_prefix_window_lane8_dh64_f16_kernel", sdpa_varlen_bwd_saved_stats_dq_dh64_f16_pso),
