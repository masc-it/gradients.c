...
_Static_assert(sizeof(gd_metal_adamw_args) == 136U, "gd_metal_adamw_args ABI mismatch");
_Static_assert(offsetof(gd_metal_adamw_args, lr) == 88U, "gd_metal_adamw_args lr offset mismatch");
_Static_assert(offsetof(gd_metal_adamw_args, step_scale) == 124U,
               "gd_metal_adamw_args step_scale offset mismatch");
_Static_assert(sizeof(gd_metal_grad_norm_stage_args) == 48U,
