...
/* Autogenerated scaffold for `concat`. TODO: document op contract after implementation. */
gd_status gd_concat(gd_context *ctx, gd_tensor *x0, gd_tensor *x1, gd_tensor **out);
