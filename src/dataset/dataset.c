...
static gd_status gd_ds_read_file(const char *path, char **text_out, size_t *len_out)
{
    FILE *f;
    long end;
    char *text;
...
static gd_status gd_ds_mkdir_p(const char *path)
{
...
static gd_status gd_ds_join_path(const char *dir, const char *name, char **out)
{
    size_t dlen;
    size_t nlen;
    size_t need;
...
static gd_status gd_ds_write_header(FILE *f,
...
static gd_status gd_ds_write_payload(FILE *f,
