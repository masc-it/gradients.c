...
int main(int argc, char **argv)
{
    ...
    cfg.params_bytes = align_up(input_bytes + 1024U * 1024U, 4096U);
    cfg.state_bytes = 1024U * 1024U;
    cfg.scratch_slot_bytes = align_up(input_bytes * 3U + 1024U * 1024U, 4096U);
...
def compile_runner(root: Path, tmp: Path) -> Path:
    source = tmp / "gd_split_fwd_runner.c"
    binary = tmp / "gd_split_fwd_runner"
