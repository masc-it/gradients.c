...
static void fill_dropout_bwd_params(gd_metal_dropout_params *p,
...
static gd_status dropout_bwd_encode(_gd_metal_encode_ctx *ctx)
{
    ...
    fill_dropout_bwd_params(&p, out_desc, node->attrs.scale, node->attrs.dropout_seed,
                            ctx->exe->run_id);
...
const _gd_metal_op _gd_metal_op_dropout_bwd = {
    .kind = _GD_OP_DROPOUT_BWD,
    .name = "dropout_bwd",
    .support = _gd_metal_support_f32_f16_same_dtype,
    .encode = dropout_bwd_encode,
};
