    ...
    *,
    ...
    manifest = {
        ...
        "storage": {
            ...
            "positions": "per-token positions reset at each document fragment inside the fixed row",
            "target_ids": "input_ids shifted by one token; -1 marks cross-document targets ignored by LM CE",
            "segment_lengths": "per-row document-fragment lengths summing to context_length",
