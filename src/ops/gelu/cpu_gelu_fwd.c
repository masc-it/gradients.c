...
static gd_status gelu_run(_gd_cpu_exec *exec, const _gd_node *node)
{
    ...
    return _gd_cpu_k_gelu(out_desc, out_data, x_data, node->attrs.gelu_tanh);
}

const _gd_cpu_op _gd_cpu_op_gelu = {
    .kind = _GD_OP_GELU,
    .name = "gelu",
