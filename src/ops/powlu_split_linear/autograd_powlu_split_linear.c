...
{
    const gd_powlu_split_linear_attrs *attrs;
    ...
    attrs = (const gd_powlu_split_linear_attrs *)gd_tape_attrs(bwd->tape,
                                                               node,
    ...
    GD_TRY(gd_powlu_split_linear_backward_with_activation(bwd->ctx,
                                                          x12,
                                                          activation,
                                                          w,
                                                          bias,
