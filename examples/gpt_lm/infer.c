...
int main(int argc, char **argv)
{
    ...
    bool tokenizer_set;
    bool dropout_set;
    gpt_config config = parse_args(argc, argv, &layers_set, &tokenizer_set, &dropout_set);
    char *metadata = NULL;
    ...
    printf("inference: checkpoint=%s prompt=\"%s\" layers=%d max_new_tokens=%d temperature=%.3f\n",
