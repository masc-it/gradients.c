...
static gd_status scale_run(_gd_cpu_exec *exec, const _gd_node *node)
{
    ...
    return _gd_cpu_k_scale(out_desc, out_data, x_data, node->attrs.scale);
}

const _gd_cpu_op _gd_cpu_op_scale = {
    .kind = _GD_OP_SCALE,
    .name = "scale",
