                                                  ...
                                                  const gd_tape_node *node)
{
    ...
    const gd_tensor *forward_stats = node->n_saved == 1U ? gd_tape_saved(bwd->tape, node, 0U) : NULL;
    ...
    if (q == NULL || k == NULL || v == NULL || cu == NULL || out == NULL || node->n_saved > 1U) {
    ...
    GD_TRY(gd_sdpa_varlen_backward_with_stats(bwd->ctx,
                                              q,
                                              k,
                                              v,
                                              cu,
