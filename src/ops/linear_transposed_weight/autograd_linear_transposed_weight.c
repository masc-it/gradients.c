...
static gd_status gd_linear_transposed_weight_autograd_backward(gd_bwd_ctx *bwd,
                                                               const gd_tape_node *node)
{
    ...
    GD_TRY(gd_linear_transposed_weight_backward(bwd->ctx,
                                                x,
                                                w,
                                                bias,
                                                &grad_out,
...
const gd_autograd_rule gd_bwd_rule_linear_transposed_weight = {
    .kind = GD_OP_LINEAR_TRANSPOSED_WEIGHT,
    .name = "linear_transposed_weight",
    .backward = gd_linear_transposed_weight_autograd_backward,
};
