...
- [ ] Change CE meta so scalar loss output dtype is F32 regardless of logits dtype.
- [ ] Change lmCE meta so output 0 loss is F32 regardless of hidden/weight dtype.
- [ ] Keep lmCE auxiliary outputs (`m`, `l`, target logits or row stats) F32.
...
- [ ] Add tests:
  - [ ] F16 logits -> F32 CE loss.
  - [ ] F16 hidden/weight -> F32 lmCE loss.
...
- [ ] embedding backward accumulates F32 weight grad.
